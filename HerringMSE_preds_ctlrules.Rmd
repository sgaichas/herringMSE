...
knitr::opts_chunk$set(echo = FALSE, fig.align='center', out.width = "\\linewidth")
if(!require(ggplot2)) {  
...
#p1 <- ggplot(CRsgoodternherrfish[1,], aes(x=c(0,FracBmsyThreshLo, FracBmsyThreshHi, 4),
#                                      y=c(0,0,FracFtarg, FracFtarg)),
#             colour=CR)+
#  geom_line()
#
#p1 + facet_wrap("OM")

#p1 <- ggplot(Nrulesgoodternherrfish, aes(x=c(minloB, maxloB, minhiB, maxhiB), y=c(0,0,minF, maxF)), colour=CR) +
#  geom_point()
#p1 + facet_wrap("OM")
