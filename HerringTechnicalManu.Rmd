...
```{r,eval=sg_figs, fig.cap="Annual proportion of herring in diet compositions for major groundfish predators of herring estimated from NEFSC food habits database. Prey identified to herring family as well as Atlantic herring are included. \\label{gfishdiets}", fig.height=8, fig.width=11, out.width='\\linewidth', message = FALSE, warning = FALSE}
