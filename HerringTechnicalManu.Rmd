...
|:---------------------|:---------------------|:-----------------|:-----------------|
| Truth                | Low: high M, low h (0.44)   | 1976-1985: fast    | 60% overestimate |
| Consequences         | Low: high M, low h (0.44)   | 2005-2014: slow | 60% overestimate |
| Fake news            | Low: high M, low h (0.44)   | 1976-1985: fast    | None             |
| Bob                  | Low: high M, low h (0.44)   | 2005-2014: slow | None             |
| Bart Simpson         | High: low M, high h (0.79)  | 1976-1985: fast    | 60% overestimate |
| Beavis               | High: low M, high h (0.79)  | 2005-2014: slow | 60% overestimate |
| Something            | High: low M, high h (0.79)  | 1976-1985: fast    | None             |
| Something else       | High: low M, high h (0.79)  | 2005-2014: slow | None             |
"
cat(tabl) # output the table in a format good for HTML/PDF/docx conversion
```

```{r MortsWts, fig.cap="Herring Natural Mortality and Weights-at-age \\label{MWttab}", echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
