...
\end{table}
-->
```{r costs, tab.cap="Marginal cost of 1mt of herring, daily catch, trip length, and adjusted cost per day for the purse seine and trawl fleets averaged over 2011-2015.\\label{costs_combined}", echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
| Year | Marginal Cost (\\$/mt) | Catch (mt/day)   | Trip length (days)  | Adjusted Cost (\\$/day) |  Observed trips  | VTR  trips  |
|:-----|---------------:|---------:|------------:|-------------:|-------:|------:|
|Seine	|	14.27 | 87.5| 1.0|	1,249	|	207	|	1,413	|
|Trawl	|	62.43 | 61.4	|2.9|	3,833	|	573	|	2,005	|
"
cat(tabl) # output the table in a format good for HTML/PDF/docx conversion
```
