...
<!---These two paragraphs are more like difficulties with doing an integrated model, not necessarily an economic problem.  If they are the only integration problems/weaknesses, I can  put them back in the economic dreams section.-->
...
<!---CJFAS requires References, Tables, then Figures.
I don't want to move the tables and figures right now. It will cause massive headaches for any merges.
-->
...
# Figures
hi. A figure!
>>>>>>> 354ffd5c369e3d4ff979edfc68fc12aaf2f80af1
