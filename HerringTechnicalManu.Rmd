...
\begin{equation}
B_{y+1}^P = S_{y}^P (\alpha_y^P N_{y} + Fw_{slope} B_{y}) + \alpha_y^PR_{y+1}, or
\end{equation}

\begin{equation}
B_{y+1} = S_{y} (Fw_{int} N_{y} + \rho_y^P B_{y}) + Fw_{int} R_{y+1}, 
\end{equation}
...
|	$u_y$	|	annual predator exploitation mortality
...
| Steepness            | 1.0          | 0.26         | 0.97         |
| Annual nat. mortality rate | 0.14         | 0.1          | 0.092        |
| Annual exploitation rate   | 0.079        | 0.00         | 0.092        |
| Growth intercept  | 0.020605     | 0.00015      | 0.000278     |
| Growth slope   | 0.9675       | 0.0          | 0.9577       |
