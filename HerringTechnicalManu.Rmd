...
```{r,eval=sg_figs, fig.cap="Annual diet compositions for major groundfish predators of herring estimated from NEFSC food habits database. Herring proportion in diet is highlighted in solid fill. \\label{gfishdiets}", message = FALSE, warning = FALSE}
