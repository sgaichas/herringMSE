...
```{r, fig.cap="Modeled herring average weight (population >180mm in length) to tuna growth relationship. See text (Herring-tuna relationship model section) for derivation. \\label{herringtuna}", message = FALSE, warning = FALSE}
# from MSE_TunaLink.R
...
dietitem + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  labs(x="Prey species group", y="Tern productivity", color='Tern species') +
  scale_colour_manual(values=c("#fdb462","#386cb0")) +
  theme_Publication() #+ scale_colour_Publication()
...
```{r YAY, fig.cap="Differences between operating models for key metrics. Boxplots represent the median (wide line within the box) and 25th and 75th percentiles (box) of each metric (x-axis label) measured across all control rule replicates and control rule types. Boxplot whiskers include the highest and lowest observations within 1.5 box lengths from the box. Observations further than 1.5 box lengths from the box (outliers) are represented by points. \\label{YAY}", fig.height=14, fig.width=11.5, out.width='\\linewidth', message = FALSE, warning = FALSE}
# metrics <- c('stouffer',
#              'stationary',
#              'p50_NR',
#              'PropClosure',
...
```{r ZZZ, fig.cap="Differences between control rule types for key metrics. Boxplots represent the median (wide line within the box) and 25th and 75th percentiles (box) of each metric (x-axis label) measured across all control rule replicates and operating models. Boxplot whiskers include the highest and lowest observations within 1.5 box lengths from the box. Observations further than 1.5 box lengths from the box (outliers) are represented by points.\\label{ZZZ}", fig.height=11, fig.width=8.5, message = FALSE, warning = FALSE}
...
```{r yieldSSB, fig.cap="Tradeoff between herring relative yield and relative SSB for HighSlowCorrect operating model and biomass based control rules with 1 year (BB), 3 year (BB3yr), or 5 year (BB5yr) quota blocks.\\label{yieldSSB}", message = FALSE, warning = FALSE}
...
```{r yieldIAV, fig.cap="Tradeoff between herring relative yield and variation in yield for HighSlowCorrect operating model and biomass based control rules with 1 year (BB), 3 year (BB3yr), or 5 year (BB5yr) quota blocks.\\label{yieldIAV}", message = FALSE, warning = FALSE}
...
```{r yieldclose, fig.cap="Tradeoff between herring relative yield and frequency of fishery closure for HighSlowCorrect operating model and biomass based control rules with 1 year (BB), 3 year (BB3yr), or 5 year (BB5yr) quota blocks.\\label{yieldPropClosure}", message = FALSE, warning = FALSE}
...
```{r yieldOF, fig.cap="Tradeoff between herring relative yield and probability of the stock is overfished for HighSlowCorrect operating model and biomass based control rules with 1 year (BB), 3 year (BB3yr), or 5 year (BB5yr) quota blocks.\\label{yieldProbOF}", message = FALSE, warning = FALSE}
...
```{r yieldbirds, fig.cap="Tradeoff between herring relative yield and probability of good tern productivity for HighSlowCorrect operating model and biomass based control rules with 1 year (BB), 3 year (BB3yr), or 5 year (BB5yr) quota blocks.\\label{yieldbirds}", message = FALSE, warning = FALSE}
...
```{r revenuestability, fig.cap="Tradeoff between herring fleet Net Revenue and Equil1 for HighSlowCorrect operating model and biomass based control rules with 1 year (BB), 3 year (BB3yr), or 5 year (BB5yr) quota blocks compared with 3 year quota block with a 15\\% restriction on annual quota changes (BB3yrPerc).\\label{revenuestability}", message = FALSE, warning = FALSE}
...
ggplot(HSCOM_BBsonly, aes(x=p50_NR, y=stouffer, colour=CR)) + 
  ...
  labs(y="equil1", x="net revenue", colour="Control rule type") +
  guides(colour = guide_legend(override.aes = list(alpha = 1))) +
  theme_Publication() + scale_colour_Publication()
