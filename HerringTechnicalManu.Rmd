...
```{r, eval=sg_figs, fig.cap="Relationship of groundfish predator (dogfish, Georges Bank cod, and Gulf of Maine cod) spawning stock biomass (SSB) with the percentage of herring in diet: both all clupeids including Atlantic herring (All Clupeids) and Atlantic herring only (A. herring). Linear model fit (line) with 95\\% CI band (gray shading) is shown for significant relationships. \\label{gfishBherrdiet}", message = FALSE, warning = FALSE}
...
gfishSSBdiet + facet_wrap(~species) + 
  stat_smooth(data = GBcodfood, method = "lm", formula = y ~ x, size = 1) +
