...
```{r revenuestability, fig.cap="Tradeoff between herring fleet Net Revenue and Equilibrium1 for HighSlowCorrect operating model and biomass based control rules with 1, 3, or 5 year quota blocks\\label{revenuestability}", message = FALSE, warning = FALSE}
...
ggplot(HSCOM_BBsonly, aes(x=p50_NR, y=stouffer, colour=CR)) + 
  ...
  labs(y="equilibrium1", x="net revenue")
#Reset this
HSCOM_BBsonly <- HiSlowCorrectOM %>%
  filter(CR %in% c("BB", "BB3yr", "BB5yr"))
