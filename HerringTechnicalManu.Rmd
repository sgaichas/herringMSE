...
```{r, eval=sg_figs, fig.cap="Relationship of groundfish predator spawning stock biomass (SSB) with the percentage of herring in diet: dogfish, Georges Bank cod, and Gulf of Maine cod.  \\label{gfishBherrdiet}", message = FALSE, warning = FALSE}
