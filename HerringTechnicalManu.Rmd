...
A third finding was that two classes of control rules (Constant Catch and the 3-year biomass based with a limit on adjustment) performed well you wanted stability and were willing to sacrifice yield.  Our Council didn't want that, and so I think we just say that our Council eliminated them and so will we.  Ultimately, we will no longer look at CC, CCC, or 15% restriction.  Here’s a few results that illustrate that finding (Figure ZZZ). Perhaps stationarity goes here?
