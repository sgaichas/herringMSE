...
The fisheries management process in New England usually starts when managers perceive a problem causing a management goal or objective to be unmet. Managers will propose solutions and a technical group, typically composed of scientists and policy analysts from state agencies and the National Marine Fisheries Service (NMFS), will analyze these possible solutions. Both managers and the technical group can be aided by an Advisory Panel, a closed group appointed by managers that is typically composed of members of the fishing industry, processing sector, and Environmental Non-Governmental Organizations (ENGOs). In addition to the public comment process, the Advisory Panel is one of the mechanisms for stakeholders to raise awareness of management problems to managers. The Council will eventually select a solution through a vote and NMFS will, after verifying that it is consistent with applicable laws, translate those solutions into regulations and enforce those regulations. Management actions, particularly contentious ones, can take years to develop and implement.
...
Bluefin tuna were identified at the stakeholder workshop as the recommended highly migratory herring predator. Common terns were identified at the stakeholder workshop as the recommended seabird herring predator. No specific groundfish or marine mammal was identified as a representative herring predator during the stakeholder workshop.
...
Population abundance and recruitment in numbers were directly output for all modeled predators. Population biomass was directly output for tuna and dogfish. Stakeholders expressed interest in predator condition for fish and marine mammal predators at the first workshop. While delay difference models do not track individuals or age cohorts, a measure of population average weight (population biomass/population numbers) was output for tuna and dogfish. 
...
### Economic Dreams
The economic model of the herring fishery did not include fixed costs. If firms do not enter or exit, then the exclusion of fixed costs from the model has minimal effect when comparing HCRs within or across OMs.  Net revenues would all be overestimated by the same fixed amount.  The stationarity metric would be unaffected; however, IAV constructed without fixed costs will be smaller than the true IAV that contains fixed costs.  However, in the long run, firms can enter and exit this industry.  Less than three-quarters of the permitted herring vessels were active in the fishery, suggesting that firms could enter if future profitability is expected to be high.  We did not model firm entry and exit; this is a difficult decision to model.  Economic theory suggests that firms will enter (exit) if they anticipate large positive (negative) profits over a particular planning horizon; however, understanding exactly how these decisions are made was not possible on the timeline requested by NEFMC.  
...
An open stakeholder driven process produced dividends for this analysis in the form of improved relationships and data.  We are cautiously optimistic that the participatory decision-making process will increase regulatory legitimacy and governance  [@Hanna1995UserCouncil].  Greater attention should be paid to what stakeholders are involved and how they are involved in MSE processes.  Probably leave a short paragraph assuming Feeney et al. accepted.
