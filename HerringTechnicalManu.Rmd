...
#Results
The MSE evaluated the performance of thousands of control rules across eight operating models.  Stakeholders had wide-ranging, diverse, and often conflicting preferences. A major piece of management advice is to present information that can actually understood and used by managers. Characterizing performance metrics and control rules that are particularly sensitive to model perturbations is an essential part of that process.  
